...
RECENT_WORK = [
    {
        ...
        "pt": {
            "title": "Reparações em casa de banho",
            "zone": "Grande Lisboa",
            "service_type": "Reparações gerais",
            "description": "Intervenções interiores, acabamentos e pequenos arranjos em casa de banho.",
            "alt": "Reparação e acabamento de chão de casa de banho na Grande Lisboa",
        },
        "en": {
            "title": "Bathroom repairs",
            "zone": "Greater Lisbon",
            "service_type": "General repairs",
            "description": "Interior work, finishes and small fixes in bathrooms.",
            "alt": "Bathroom floor repair and finishing in Greater Lisbon",
        },
        "es": {
            "title": "Reparaciones en baño",
            "zone": "Gran Lisboa",
            "service_type": "Reparaciones generales",
            "description": "Intervenciones interiores, acabados y pequeños arreglos en baños.",
            "alt": "Reparación y acabado de suelo de baño en la Gran Lisboa",
        },
        "fr": {
            "title": "Réparations salle de bain",
            "zone": "Grand Lisbonne",
            "service_type": "Réparations générales",
            "description": "Interventions intérieures, finitions et petits travaux en salle de bain.",
            "alt": "Réparation et finition de sol de salle de bain dans le Grand Lisbonne",
        },
    },
    {
