...
HOME_UI = {
    "pt": {
        ...
        "recent_work_subtitle": "Antes e depois de intervenções reais na Grande Lisboa e Margem Sul — reparações, pintura, remodelação e muito mais.",
        "recent_work_before": "Antes",
        "recent_work_after": "Depois",
        "recent_work_card_cta": "Orçamento no WhatsApp",
        "recent_work_cta": "Quero um resultado assim",
    ...
    "en": {
        ...
        "recent_work_subtitle": "Before and after from real jobs across Greater Lisbon and the South Bank — repairs, painting, renovations and more.",
        "recent_work_before": "Before",
        "recent_work_after": "After",
        "recent_work_card_cta": "Quote on WhatsApp",
        "recent_work_cta": "I want a result like this",
    ...
    "es": {
        ...
        "recent_work_subtitle": "Antes y después de trabajos reales en la Gran Lisboa y Margen Sur: reparaciones, pintura, reformas y más.",
        "recent_work_before": "Antes",
        "recent_work_after": "Después",
        "recent_work_card_cta": "Presupuesto por WhatsApp",
        "recent_work_cta": "Quiero un resultado así",
    ...
    "fr": {
        ...
        "recent_work_subtitle": "Avant et après d'interventions réelles dans le Grand Lisbonne et la Rive Sud — réparations, peinture, rénovation et plus.",
        "recent_work_before": "Avant",
        "recent_work_after": "Après",
        "recent_work_card_cta": "Devis sur WhatsApp",
        "recent_work_cta": "Je veux ce résultat",
...
RECENT_WORK_WA = {
    "pt": "Olá! Vi a secção de trabalhos recentes e gostaria de um orçamento.",
    "en": "Hello! I saw the recent work section and would like a quote.",
    "es": "¡Hola! Vi la sección de trabajos recientes y me gustaría un presupuesto.",
    "fr": "Bonjour ! J'ai vu la section travaux récents et je souhaite un devis.",
}
